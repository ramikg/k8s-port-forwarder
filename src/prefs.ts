...
export default class K8sPortForwarderPreferences extends ExtensionPreferences {
    ...
    async fillPreferencesWindow(window: Adw.PreferencesWindow) {
        ...
        const rebuild = () => {
            if (currentPage) window.remove(currentPage);
            ...
            addDirectoryRow.add_prefix(new Gtk.Image({icon_name: 'list-add-symbolic'}));
        ...
        const buildDirectoryExpander = (
            ...
            addResourceRow.add_prefix(new Gtk.Image({icon_name: 'list-add-symbolic'}));
        ...
        const buildResourceRow = (
            ...
            const localPortRow = createPortRow('Local Port', resource.localPort);
            ...
            const remotePortRow = createPortRow('Remote Port', resource.remotePort);
